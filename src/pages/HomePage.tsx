...
function Description() {
  return (
    <div className="absolute inset-0 flex items-center justify-center">
      <div className="bg-white bg-opacity-50 p-8 rounded-lg w-3/4">
        <p className="mt-4 text-lg text-gray-600 text-center">
          About Us:
          As the official hiking club for Imperial College London, we are your gateway to discovering the breathtaking landscapes and hidden gems of the United Kingdom. We specialize in crafting unforgettable hiking experiences that encompass day hikes, thrilling weekend trips, and captivating tours across the UK.
